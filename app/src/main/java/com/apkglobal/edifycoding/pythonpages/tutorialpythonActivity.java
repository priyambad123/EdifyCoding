...
import com.apkglobal.edifycoding.RecyclerView.RecyclerAdapter4;
import com.apkglobal.edifycoding.authentication.LoginActivity;
import com.google.firebase.auth.FirebaseAuth;

public class tutorialpythonActivity extends AppCompatActivity {
    ...
    private void logout() {
        ...
        Intent intent = new Intent(tutorialpythonActivity.this, LoginActivity.class);
