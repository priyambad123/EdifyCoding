...
public class overviewpythonActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_overviewpython);

        TextView myTextView=(TextView)findViewById(R.id.pythonoverviewtitle);
    ...
    private void logout() {
        ...
        Intent intent = new Intent(overviewpythonActivity.this, LoginActivity.class);
