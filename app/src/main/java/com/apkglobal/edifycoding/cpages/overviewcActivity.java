...
public class overviewcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overviewc);

        TextView myTextView=(TextView)findViewById(R.id.coverviewtitle);
    ...
    private void logout() {
        ...
        Intent intent = new Intent(overviewcActivity.this, LoginActivity.class);
