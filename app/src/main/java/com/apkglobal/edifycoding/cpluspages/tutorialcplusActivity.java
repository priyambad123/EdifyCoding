...
import com.apkglobal.edifycoding.RecyclerView.RecyclerAdapter2;
import com.apkglobal.edifycoding.authentication.LoginActivity;
import com.google.firebase.auth.FirebaseAuth;

public class tutorialcplusActivity extends AppCompatActivity {
    private RecyclerView recyclerView2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tutorialcplus);
    ...
    private void logout() {
        ...
        Intent intent = new Intent(tutorialcplusActivity.this, LoginActivity.class);
