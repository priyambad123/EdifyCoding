...
public class overviewandroidActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_overviewandroid);

        TextView myTextView=(TextView)findViewById(R.id.andoverviewtitle);
    ...
    private void logout() {
        ...
        Intent intent = new Intent(overviewandroidActivity.this, LoginActivity.class);
