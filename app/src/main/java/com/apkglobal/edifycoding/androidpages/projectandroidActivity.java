...
public class projectandroidActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_projectandroid);
        Toast.makeText(this, "Loading Please Wait", Toast.LENGTH_SHORT).show();

        webview=(WebView)findViewById(R.id.btn_projectand);
        webview.loadUrl("http://1000projects.org/android-projects-with-source-code.html");
    }
    ...
    private void logout() {
        ...
        Intent intent = new Intent(projectandroidActivity.this, LoginActivity.class);
